...
sourcesIndex["sky_sl"] = {"name":"","dirs":[{"name":"db","files":["mod.rs","source.rs","storage.rs","syntax.rs"]},{"name":"hir","files":["mod.rs"]},{"name":"lexer","files":["cursor.rs","identifier.rs","literal.rs","mod.rs","token.rs"]},{"name":"parser","files":["error.rs","mod.rs","parser.rs"]},{"name":"syn","dirs":[{"name":"ast","dirs":[{"name":"expression","files":["binary_expression.rs","group_expression.rs","literal_expression.rs","mod.rs","path_expression.rs"]},{"name":"statement","files":["let_statement.rs","mod.rs"]}],"files":["arguments.rs","block.rs","function.rs","identifier.rs","member.rs","mod.rs","module.rs","root.rs","structure.rs","type_identifier.rs"]},{"name":"cst","files":["line_index.rs","mod.rs","syntax_kind.rs","trivia.rs"]}],"files":["mod.rs"]},{"name":"workspace","files":["error.rs","fs.rs","mod.rs","package.rs"]}],"files":["lib.rs"]};
